...
# print(mydata)
# print(mydata.keys())
# print(mydata['AWSTemplateFormatVersion'])
# print(mydata['Description'])
# print(mydata['Metadata'])
# print(mydata.get('Metadata'))
print(mydata.get('Metadata').keys())
# print(mydata['Metadata']['AWS::CloudFormation::Interface'].keys())
#print(mydata.get('AWS::CloudFormation::Interface').keys())
# print(mydata['Metadata']['AWS::CloudFormation::Interface'])
# print(mydata['Metadata']['AWS::CloudFormation::Interface'].keys())
# print(mydata['Metadata']['AWS::CloudFormation::Interface']['QuickStartDocumentation'])
# print(mydata['Metadata']['AWS::CloudFormation::Interface']['QuickStartDocumentation'].keys())
